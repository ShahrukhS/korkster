						...
						<tbody>
							<tr>
								<td style="text-align:left;padding-bottom:14px;">
									<img align="left" alt="WalknSell" src="http://walknsell.com/img/walk_sell_logo.png">
								</td>
							</tr>
							<tr>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="font-size:20px; color:#000; line-height:27px;text-align:center;max-width:650px;padding-bottom:20px;">
                                                    <a href="https://www.fiverr.com/ios_app?from_email=true" style="text-decoration:none;color:white;" target="_blank">
