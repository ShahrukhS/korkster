...
$subject = "WalkNSell: Activate Your New Account";
			  ...
			  <tbody>
				<tr>
				  <td><table align='center' cellspacing='0' style='max-width:650px;min-width:320px'>
					  <tbody>
						<tr>
						  <td style='text-align:left;padding-bottom:14px'><img align='left' alt='WalkNSell' src='http://walknsell.com/img/walk_sell_logo.png'></td>
						</tr>
						<tr>
						...
						<tr>
						  <td align='center' style='background:#f8f8f8;border:1px solid #e4e4e4;border-top:none;padding:24px 10px'><table align='center' style='width:100%;max-width:650px'>
				              ...
				              <!--<tr>
								...
								<tr>
								  <td style='font-size:20px;line-height:27px;text-align:center;max-width:650px'><a href='' style='text-decoration:none;color:#69696c' target='_blank'> <span style='color:#00ce00;font-weight:bold;max-width:180px'>NEW!</span> All the Deals<sup style='font-size:14px'>®</sup> You Need <br>
									Now in Your Pocket </a></td>
								</tr>
							  </tbody>
							</table></td>
						</tr>
				...
				<tr>
				  <td><table align='center' style='max-width:650px'>
					  <tbody>
						<tr>
						  <td style='color:#b4b4b4;font-size:11px;padding-top:10px;line-height:15px;font-family:arial'> © Avialdo 2014-2016, WalkNSell®, Deal®, DealS®, I WILL__for$5, The Things People Do For $5, DamnQuickPay, WalkNSell graphics, logos, scripts, terms of use, instructions, designs and others service names are the trademarks and copyright of Avialdo.</td>
						</tr>
					  </tbody>
					</table></td>
				</tr>
